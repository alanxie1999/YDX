...
def _build_help_card() -> str:
    return (
        ...
        "常用：<code>st</code> <code>mt</code> <code>status</code> <code>pause</code> <code>balance</code>\n\n"
        "<b>⚡ 基础控制（最常用）</b>\n"
        "• <code>/st [预设名]</code> 启动（跟随同向下注）\n"
        "• <code>/mt [预设名]</code> 启动（交替反向下注）\n"
        ...
        "<b>💸 倍投模式（常用）</b>\n"
        "• <code>/st 5k</code> 首注 500，跟随同向\n"
        "• <code>/st 1w</code> 首注 1000，跟随同向\n"
        "• <code>/st 2w/3w/5w/10w/15w/20w/30w</code> 更高阶倍投\n\n"
        "<b>🔄 交替下注（mt 命令）</b>\n"
        ...
        "• <code>/res config</code> 清除所有下注配置，恢复默认\n"
        "• <code>/ver</code> 查看版本\n"
        ...
        "<b>📊 历史记录</b>\n"
        "• 自动保存到 <code>/workspace/YDX/logs/YYYY-MM-DD.txt</code>\n"
...
def _save_history_to_file(state, rt: dict, win: bool, profit: int, bet_amount: int, prediction: int, result: int):
    ...
    # 创建 YDX/logs 目录
    history_dir = "/workspace/YDX/logs"
